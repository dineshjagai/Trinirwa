...
export default function TweetDisplayer({tweets, deleteTweet}){
    const all = [{"uid":3,"tweet_id":5,"type":"text","content":"Je vais a l'ecole","tweet_date":"0000-00-00 00:00:00","tweet_likes":10},
    ...
    const items = all.map((tweet)=>
      <Tweet key={tweet.tweet_id} data={tweet}/>
    );
